using System.Text;
using Trees___Binary_trees.Models;
...
internal class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        Console.Write(string.Join(", ", tree.Traverse(Trees___Binary_trees.TraversalType.PREORDER).Select(n => n.Data)));

        Console.Write("\nIn-order traversal:\t");
        Console.Write(string.Join(", ", tree.Traverse(Trees___Binary_trees.TraversalType.INORDER).Select(n => n.Data)));

        Console.Write("\nPost-order traversal:\t");
        Console.Write(string.Join(", ", tree.Traverse(Trees___Binary_trees.TraversalType.POSTORDER).Select(n => n.Data)));
