...
internal class Program
{
    ...
    {
        Console.WriteLine("This is the telecommunication cable example using Minimum Spanning Tree with Kruskal's and Prim's algorithms: ");
